...
public class ImageDetailFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        DisplayImageOptions  optionsone = new DisplayImageOptions.Builder()
                ...
                .build();
        ImageLoader.getInstance().displayImage(mImageUrl, mImageView,optionsone, new SimpleImageLoadingListener() {
            @Override
            ...
            public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                ...
                MyToast.makeText(getActivity(), message, Toast.LENGTH_SHORT).show();
