...
import com.lvgou.distribution.widget.AnimateFirstDisplayListener;
import com.lvgou.distribution.widget.FixedSpeedScroller;
import com.lvgou.distribution.widget.SawtoothView;
 ...
 */
public class CollegeAdViewPage extends RelativeLayout {
    ...
    public CollegeAdViewPage(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }

    public CollegeAdViewPage(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        this.context = context;
        init();
    }

    public CollegeAdViewPage(Context context) {
        super(context);
        this.context = context;
        init();
    }
    ...
    private void init() {
        View layoutHeader = View.inflate(getContext(),
                R.layout.activity_college_ad_top, this);
