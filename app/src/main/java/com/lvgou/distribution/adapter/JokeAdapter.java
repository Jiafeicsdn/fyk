...
public class JokeAdapter extends BaseAdapter implements JokeOperationView, JokeCollectionView, CancelJokeCollectionView {
    Context context;
    ...
    public JokeAdapter(Context _context) {
...
//        lv_skills.addFooterView(footerView);
        ...
        rl_ding.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (info.get("State").toString().equals("1")) {
                    ...
                    ((JokeActivity) context).showLoadingProgressDialog(context, "");
    ...
    public void OnJokeOperationSuccCallBack(String state, String respanse) {
        ((JokeActivity) context).closeLoadingProgressDialog();
        //踩或者顶成功
