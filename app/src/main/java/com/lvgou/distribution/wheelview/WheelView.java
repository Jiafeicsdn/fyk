...
package com.lvgou.distribution.wheelview;
...
import com.lvgou.distribution.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	 ...
	 */
//    private int[] SHADOWS_COLORS = new int[]{0xFFffffff, 0x00ffffff, 0xFFffffff};
    private int[] SHADOWS_COLORS = new int[]{0x404040, 404040, 0x404040};
//    private int[] SHADOWS_COLORS = new int[]{0xFF111111, 0x00AAAAAA, 0x00AAAAAA};
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.bg_line));
        // 设置线宽
