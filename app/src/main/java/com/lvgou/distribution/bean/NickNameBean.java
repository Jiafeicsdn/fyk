...
public class NickNameBean implements Serializable {
    ...
    public void setServiceRealName(String serviceRealName) {
        ServiceRealName = serviceRealName;
    }
    ...
    public void setTuanBi(int tuanBi) {
        TuanBi = tuanBi;
    }
    ...
    public void setFengwenCount(int fengwenCount) {
