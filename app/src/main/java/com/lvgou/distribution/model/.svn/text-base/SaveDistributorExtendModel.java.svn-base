...
public interface SaveDistributorExtendModel {
    /**
     ...
     * @return
     */
    void saveDistributorExtend(String distributorid, int sexgander, String countryPath, String workDay, String education,
