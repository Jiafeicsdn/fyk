...
public class CutView extends ImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (origBitmap != null) {
            ...
            // 绘制上方形
            Rect rectOne = new Rect(viewWidth / 2 - cutRadius, viewHeight / 2 - cutRadius, viewWidth / 2 + cutRadius, viewHeight / 2 + cutRadius);
            ...
            switch (pathType) {
                case OVAL:
                    ...
                    break;
                case RECT:
                    path.addRect(new RectF(rectOne), Path.Direction.CCW);
                    break;
                case ROUNDRECT:
