 ...
 */
public class GroupSendViewHolder extends ViewHolderBase<GroupIndexEntity> {
    ...
    public void showData(int position, final GroupIndexEntity itemData) {
        ...
        } else if ((start_date.getTime() - end_date.getTime()) / 1000 > 0 && itemData.getImg_state().equals("2")) {
    ...
    public static void setGroupIndexEntityOnListItemClickListener(OnListItemClickListener<GroupIndexEntity> groupIndexEntityOnListItemClickListener) {
        GroupSendViewHolder.groupIndexEntityOnListItemClickListener = groupIndexEntityOnListItemClickListener;
    }
}
