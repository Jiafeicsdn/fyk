 ...
 */
public class CircleUserViewHolder1 extends ViewHolderBase<CircleUserEntity> {
    ...
    public static void setCircleUserEntityOnClassifyPostionClickListener(OnClassifyPostionClickListener<CircleUserEntity> circleUserEntityOnClassifyPostionClickListener) {
        CircleUserViewHolder1.circleUserEntityOnClassifyPostionClickListener = circleUserEntityOnClassifyPostionClickListener;
    }
}
