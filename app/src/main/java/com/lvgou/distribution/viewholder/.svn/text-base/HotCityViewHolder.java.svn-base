...
public class HotCityViewHolder extends ViewHolderBase<ProvinceEntity> {
    ...
    public View createView(LayoutInflater layoutInflater) {
        ...
        View view = layoutInflater.inflate(R.layout.item_gridview_hot_city, null);
    ...
    public void showData(int position, final ProvinceEntity itemData) {
        if (Constants.SELECTE_POSITION06.equals(itemData.getName())) {
            tv_city.setBackgroundResource((R.drawable.bg_conner_circle_green_shape));
            tv_city.setTextColor(context.getResources().getColor(R.color.bg_white));
        } else {
    ...
    public static void setClassifyEntityOnClassifyPostionClickListener(OnClassifyPostionClickListener<ProvinceEntity> classifyEntityOnClassifyPostionClickListener) {
        HotCityViewHolder.classifyEntityOnClassifyPostionClickListener = classifyEntityOnClassifyPostionClickListener;
    }
}
