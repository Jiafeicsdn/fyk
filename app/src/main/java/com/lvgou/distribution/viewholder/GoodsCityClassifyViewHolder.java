 ...
 */
public class GoodsCityClassifyViewHolder extends ViewHolderBase<ClassifyEntity> {
    ...
    public void showData(int position, final ClassifyEntity itemData) {
        if (Constants.SELECTE_POSITION02.equals(itemData.getId())) {
        ...
        rl_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Constants.SELECTE_POSITION02 = itemData.getId();
    ...
    public static void setClassifyEntityOnClassifyPostionClickListener(OnClassifyPostionClickListener<ClassifyEntity> classifyEntityOnClassifyPostionClickListener) {
        GoodsCityClassifyViewHolder.classifyEntityOnClassifyPostionClickListener = classifyEntityOnClassifyPostionClickListener;
    }
}
