 ...
 */
public class GridBackViewOneHolder extends ViewHolderBase<ClassifyEntity> {
    ...
    public void showData(int position, final ClassifyEntity itemData) {
        if (Constants.SELECTE_POSITION08.equals(itemData.getName())) {
        ...
        rl_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Constants.SELECTE_POSITION08 = itemData.getName();
    ...
    public static void setClassifyEntityOnClassifyPostionClickListener(OnClassifyPostionClickListener<ClassifyEntity> classifyEntityOnClassifyPostionClickListener) {
        GridBackViewOneHolder.classifyEntityOnClassifyPostionClickListener = classifyEntityOnClassifyPostionClickListener;
    }
}
