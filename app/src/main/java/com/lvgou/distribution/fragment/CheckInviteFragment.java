...
//        mListView.stopLoadMore();
    ...
    private void initDatas() {
        ...
        String sign = TGmd5.getMD5(distributorid + 3 + page);
        ((InviteRecordActivity) getActivity()).showLoadingProgressDialog(getActivity(), "");
        myInviteListPresenter.myInviteList(distributorid, 3, page, sign);
    }
    ...
    private static class mainHandler extends Handler {
        ...
        public mainHandler(CheckInviteFragment activity) {
            mActivity = new WeakReference<CheckInviteFragment>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            CheckInviteFragment activity = mActivity.get();
            if (activity != null) {
