...
public class CollecteJokeFragment extends Fragment implements XListView.IXListViewListener, CollectionListView {
    private View view;
    ...
    private CollecteJokeAdapter jokeAdapter;
    ...
    private void initView() {
        ...
        jokeAdapter = new CollecteJokeAdapter(getActivity());
...
sign 	是 	string 	签名
    ...
    private void initDatas() {
        ...
        collectionListPresenter.collectionList(distributorid, 1, page, sign);
    }
    ...
    private static class mainHandler extends Handler {
        private final WeakReference<CollecteJokeFragment> mActivity;

        public mainHandler(CollecteJokeFragment activity) {
            mActivity = new WeakReference<CollecteJokeFragment>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            CollecteJokeFragment activity = mActivity.get();
            if (activity != null) {
