...
//        mListView.stopLoadMore();
    ...
    private void showPopWindow(final HashMap<String, Object> info) {
        ...
        tv_edit_act.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MyToast.makeText(getActivity(), "编辑活动", Toast.LENGTH_SHORT).show();
                popWindows.cleanPopAlpha();
            }
        });
    ...
    private void initDatas() {
        ...
        activityForMePresenter.activityForMeDatas(distributorid, 2, page, sign);
    ...
    private static class mainHandler extends Handler {
        ...
        public mainHandler(EndCreActFragment activity) {
            mActivity = new WeakReference<EndCreActFragment>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            EndCreActFragment activity = mActivity.get();
            if (activity != null) {
