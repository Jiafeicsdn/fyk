package com.lvgou.distribution.luban;
...
import static com.lvgou.distribution.luban.Preconditions.checkNotNull;
...
public class Luban {
    ...
    private File compress(String largeImagePath, String thumbFilePath, int width, int height, int angle, long size) {
        ...
        String format= largeImagePath.substring(largeImagePath.lastIndexOf("."));
        thumbFilePath=thumbFilePath+format;
