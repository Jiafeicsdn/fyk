...
public class AdViewpagerUtil {
     ...
     * @param urls
     */
    public AdViewpagerUtil(Context context, ViewPager viewPager, ArrayList<String> urls) {
     ...
     * @param dotsize
     */
    public AdViewpagerUtil(Context context, ViewPager viewPager, LinearLayout dotlayout, int dotsize) {
        this.context = context;
        this.viewPager = viewPager;
    ...
    public AdViewpagerUtil(Context context, ViewPager viewPager, LinearLayout dotlayout, int dotsize,int dotoffset, ArrayList<String> urls) {
        this.context = context;
        this.viewPager = viewPager;
        this.dotlayout = dotlayout;
        this.dotsize = dotsize;
