package com.lvgou.distribution.pullstopview;
...
import com.lvgou.distribution.pullstopview.AutoHorizontalScrollView;
...
public class MoguLayout extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        topView = findViewById(R.id.rl_top_view);
        viewPager = (ViewPager) findViewById(R.id.id_viewpager);
        menu = (LinearLayout) findViewById(R.id.ll_tab_view);
    }
...
//                        return true;
//                    }
                    if (!isTopHidden && dy < 0 || !isTopHidden && view != null && view.getTop() == 0 && scrollY != 0 || (view != null && view.getTop() == 0 && isTopHidden && dy > 0)) {
                        initVelocityTrackerIfNotExists();
                        mLastY = y;
                        mVelocityTracker.addMovement(ev);
                        return true;
