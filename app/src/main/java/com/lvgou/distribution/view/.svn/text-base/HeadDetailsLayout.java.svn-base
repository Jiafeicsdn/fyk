 ...
 */
public class HeadDetailsLayout extends LinearLayout {
    ...
    public HeadDetailsLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        params.height = height - menu.getMeasuredHeight() - dip2px(45);
    }
