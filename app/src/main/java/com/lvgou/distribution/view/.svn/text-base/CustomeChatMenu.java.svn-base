...
public class CustomeChatMenu extends LinearLayout {
    ...
    public CustomeChatMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.context = context;
        initView(context);
    }

    public CustomeChatMenu(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        initView(context);
    }
...
/*
        ...
        rl_video = (RelativeLayout) view.findViewById(R.id.rl_vide);*/
...
//        PowerImageView imageView1=new PowerImageView(context);
    ...
    public void OnClick() {
        ...
        //表情按鈕
        rl_emoji_small.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (null == mFaceHelper) {
...
//    }
    ...
    public static void setOnBottomMenuClickListener(OnBottomMenuClickListener onBottomMenuClickListener) {
        CustomeChatMenu.onBottomMenuClickListener = onBottomMenuClickListener;
    }
