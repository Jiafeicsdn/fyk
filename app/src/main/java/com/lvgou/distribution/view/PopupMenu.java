...
public class PopupMenu extends PopupWindow implements OnClickListener {
    ...
    public PopupMenu(Activity activity) {
        ...
        popView = inflater.inflate(R.layout.popwindow_menu, null);// 加载菜单布局文件
        ...
        // 获取选项卡
        v_item1 = popView.findViewById(R.id.rl_online_custom);
        v_item2 = popView.findViewById(R.id.rl_rexian);
