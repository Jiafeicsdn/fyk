...
public class ActivityBMActivity extends BaseActivity implements OnListItemClickListener<TuanYuanEntity>, DistributorHomeView {
    ...
    public void getData(String id, String pageindex, String keyword, String sign) {
        ...
        maps.put("activityid", id);
        maps.put("pageindex", pageindex);
        maps.put("keyword", keyword);
        maps.put("sign", sign);
        RequestTask.getInstance().doActSeekApplyers(ActivityBMActivity.this, maps, new OnRequestListener());
    }
    ...
    public void OnDistributorHomeSuccCallBack(String state, String respanse) {
        ...
        try {
            ...
            if (distributorModeljsa.get("UserType").toString().equals("3")) {
                //如果是讲师
                Intent intent1 = new Intent(ActivityBMActivity.this, TeacherHomeActivity.class);
                intent1.putExtra("seeDistributorId", distributorModeljsa.get("ID").toString());
                startActivity(intent1);
            } else {
                //普通导游
                Intent intent1 = new Intent(ActivityBMActivity.this, DistributorHomeActivity.class);
                intent1.putExtra("seeDistributorId", distributorModeljsa.get("ID").toString());
                startActivity(intent1);
            }
    ...
    private class OnRequestListener extends OnRequestListenerAdapter<Object> {
        ...
        public void onRequestPrepare() {
            ...
            showLoadingProgressDialog(ActivityBMActivity.this, "");
        }
...
//                            String name = str[0].toString();
                            String img_path = jsonObject_.getString("ActivityTitle");
