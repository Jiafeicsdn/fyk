 ...
 * 我的粉丝列表
 */
public class MyFansListActivity extends BaseActivity implements GroupView,Concern_FansAdapter.OnClassifyPostionClickListener{
...
//    private ListViewDataAdapter<CircleUserEntity> circleUserEntityListViewDataAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        distributorid = PreferenceHelper.readString(MyFansListActivity.this, SPConstants.SHARED_PREFERENCE_NAME, SPConstants.LOGIN_USERID);
        ...
        if (checkNet()) {
            showLoadingProgressDialog(MyFansListActivity.this, "");
...
//        listView.setAdapter(circleUserEntityListViewDataAdapter);
    ...
    public void initCreateView() {
        ...
        pullToRefreshListView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            ...
            public void onPullDownToRefresh(PullToRefreshBase<ListView> refreshView) {
                String label = DateUtils.formatDateTime(MyFansListActivity.this, System.currentTimeMillis(), DateUtils.FORMAT_SHOW_TIME | DateUtils.FORMAT_SHOW_DATE | DateUtils.FORMAT_ABBREV_ALL);
            ...
            public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
                mIsUp = true;
                LogUtils.e("total_page==" + total_page);
                LogUtils.e("type==" + type);

                if (pageindex < total_page) {
                    pageindex += 1;
                    String sign_one = TGmd5.getMD5(distributorid + seeDistributorId + pageindex);
                    fansFollowListPresenter.getFansList(distributorid, seeDistributorId, pageindex + "", sign_one);

                } else {
                    MyToast.show(MyFansListActivity.this, "没有更多数据");
    ...
    public void showQuitDialog(final String id) {
        dialog_del_can = new Dialog(MyFansListActivity.this, R.style.Mydialog);
        View view1 = View.inflate(MyFansListActivity.this, R.layout.dialog_quit_show, null);
