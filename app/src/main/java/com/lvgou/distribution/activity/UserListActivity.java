 ...
 * 推荐好友列表
 */
public class UserListActivity extends BaseActivity implements GroupView,Concern_FansAdapter.OnClassifyPostionClickListener{
...
//    private ListViewDataAdapter<CircleUserEntity> circleUserEntityListViewDataAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        distributorid = PreferenceHelper.readString(UserListActivity.this, SPConstants.SHARED_PREFERENCE_NAME, SPConstants.LOGIN_USERID);
        listView = pullToRefreshListView.getRefreshableView();

        recommendFriendPresenter = new RecommendFriendPresenter(this);

        initCreateView();
        initViewHolderUser();

        if (checkNet()) {
            showLoadingProgressDialog(UserListActivity.this, "");
            String sign = TGmd5.getMD5(distributorid + pageindex);
            recommendFriendPresenter.getRecommendFriend(distributorid, pageindex + "", sign);
        }
    }
...
//        listView.setAdapter(circleUserEntityListViewDataAdapter);
    ...
    public void initCreateView() {
        ...
        pullToRefreshListView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            ...
            public void onPullDownToRefresh(PullToRefreshBase<ListView> refreshView) {
                String label = DateUtils.formatDateTime(UserListActivity.this, System.currentTimeMillis(), DateUtils.FORMAT_SHOW_TIME | DateUtils.FORMAT_SHOW_DATE | DateUtils.FORMAT_ABBREV_ALL);
            ...
            public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
                ...
                if (pageindex < total_page) {
                    ...
                    MyToast.show(UserListActivity.this, "没有更多数据");
    ...
    public void showQuitDialog(final String id) {
        dialog_del_can = new Dialog(UserListActivity.this, R.style.Mydialog);
        View view1 = View.inflate(UserListActivity.this,
        ...
        sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                recommendFriendPresenter.cancleFollow(distributorid, id, sign);
            }
        });
        ...
        switch (postion) {
            ...
            case 2:
                ...
                if (itemData.getTuanBi().equals("1")) {//加关注
                    ...
                    recommendFriendPresenter.doFollow(distributorid, itemData.getID(), sign);
                } else {// 取消关注
    ...
    public void onResume() {
        ...
        recommendFriendPresenter.attach(this);
    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        recommendFriendPresenter.dettach();
    }
}
