...
public class FabuActActivity extends BaseActivity implements View.OnClickListener, ActivitySubmitView {
    ...
    private void initView() {
        ...
        et_detail_place.setSingleLine(false);
        et_detail_place.setHorizontallyScrolling(false);
    ...
    public void TextChangeListener() {
        et_simple_introduce.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (Integer.parseInt(length) >= 0 && Integer.parseInt(length) <= 1000) {
                    tv_text_num.setText(length + "/1000");
                }
            }
        ...
        et_maxpeople.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            }
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                String stret = et_maxpeople.getText().toString();
                int length = et_maxpeople.getText().toString().length();
                if (length == 5) {
                    showOneDialog();
                    et_maxpeople.setText(stret.substring(1, 5));
                }
            }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_select_gallery://从相册选择
                ...
                permissionManager = new PermissionManager(new PermissionManager.PermissionListener() {
                    ...
                    public void permissionGranted(int requestCode) {
                        if (requestCode == 99) {
                            PhotoPickerIntent intent = new PhotoPickerIntent(FabuActActivity.this);
                ...
                //申请读权限，和照相机权限
                permissionManager.checkPermission(99, FabuActActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.CAMERA);
                break;
                ...
                PermissionsManager.getInstance().requestPermissionsIfNecessaryForResult(this,
                        new String[]{Manifest.permission.CAMERA}, new PermissionsResultAction() {
                            ...
                            public void onGranted() {
                                imagePath = FunctionUtils.chooseImageFromCamera(FabuActActivity.this, REQUEST_CODE_CAMERA, "cameraImage");
                            }
            ...
            case R.id.tv_click_xieyi://蜂优客服务协议
                ...
                bundle.putString("url", "http://agent.quygt.com/user/activityprotocol.html");
            ...
            switch (requestCode) {
                case REQUEST_CODE_CAMERA://拍照的
                    if (!StringUtils.isEmpty(imagePath)) {
                        showLoadingProgressDialog(FabuActActivity.this, "");
...
//                            compressWithRx(new File(imagePath));
    ...
    private void compressWithRx(final File fileoo) {
        if (fileoo.exists()) {
            ...
            new Handler(Looper.getMainLooper()).post(new Runnable() {
                @Override
                public void run() {
                    MyToast.show(FabuActActivity.this, "蜂优客没有系统权限，文件目录不存在");
                }
            });
        }
    }
    ...
    public void doUpload(File file, String sign) {
        ...
        maps.put("sign", sign);
        RequestTask.getInstance().doActivityUploadImage(FabuActActivity.this, maps, new FabuActActivity.OnUploadRequestListener());
    }
        ...
        public void onDone(XDroidRequest<?> request, String response, DataType dataType) {
            ...
            try {
                ...
                if (status.equals("1")) {
                    ...
                    Glide.with(FabuActActivity.this).load(Url.ROOT + array.get(0).toString()).into(im_picture_path);
                    ...
                    MyToast.show(FabuActActivity.this, "上传失败");
                }
...
//          closeLoadingProgressDialog();
    ...
    public void OnActivitySubmitSuccCallBack(String state, String respanse) {
        closeLoadingProgressDialog();
        finish();
        EventBus.getDefault().post("fabuactisuccess");
