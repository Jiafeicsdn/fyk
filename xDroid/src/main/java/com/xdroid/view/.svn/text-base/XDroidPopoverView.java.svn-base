...
public class XDroidPopoverView extends RelativeLayout implements OnTouchListener{
	...
	public static interface PopoverViewListener{
		 ...
		 */
		void popoverViewWillShow(XDroidPopoverView view);
		 ...
		 * @param view The whole popover view
		 */
		void popoverViewDidShow(XDroidPopoverView view);
		 ...
		 * @param view The whole popover view
		 */
		void popoverViewWillDismiss(XDroidPopoverView view);
		 ...
		 * @param view The whole popover view
		 */
		void popoverViewDidDismiss(XDroidPopoverView view);
	}
	 ...
	 */
	public XDroidPopoverView(Context context) {
		super(context);
		initPopoverView();
	}
	 ...
	 */
	public XDroidPopoverView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initPopoverView();
	}
	 ...
	 */
	public XDroidPopoverView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initArrow(Rect originRect, Integer arrowDirection){
		...
		if (arrowDirection == XDroidPopoverView.PopoverArrowDirectionUp){
		...
		else if (arrowDirection == XDroidPopoverView.PopoverArrowDirectionDown){
		...
		else if (arrowDirection == XDroidPopoverView.PopoverArrowDirectionLeft){
		...
		else if (arrowDirection == XDroidPopoverView.PopoverArrowDirectionRight){
	...
	private void addAvailableRects(Rect originRect, int arrowDirections){
		...
		if ((arrowDirections & XDroidPopoverView.PopoverArrowDirectionUp) != 0){
			possibleRects.put(XDroidPopoverView.PopoverArrowDirectionUp, getRectForArrowUp(originRect));
		}
		if ((arrowDirections & XDroidPopoverView.PopoverArrowDirectionDown) != 0){
			possibleRects.put(XDroidPopoverView.PopoverArrowDirectionDown, getRectForArrowDown(originRect));
		}
		if ((arrowDirections & XDroidPopoverView.PopoverArrowDirectionRight) != 0){
			possibleRects.put(XDroidPopoverView.PopoverArrowDirectionRight, getRectForArrowRight(originRect));
		}
		if ((arrowDirections & XDroidPopoverView.PopoverArrowDirectionLeft) != 0){
			possibleRects.put(XDroidPopoverView.PopoverArrowDirectionLeft, getRectForArrowLeft(originRect));
		}
	...
	public void showPopoverFromRectInViewGroup(ViewGroup group, Rect originRect, int arrowDirections, boolean animated){
		...
		popoverLayoutRect = XDroidPopoverView.getFrameForView(superview);
			...
			if (!isAnimating){
				...
				animation.setAnimationListener(new AnimationListener() {
					...
					public void onAnimationEnd(Animation animation) {
						...
						//Tell delegate we did show
						if (popoverViewListener != null)
							popoverViewListener.popoverViewDidShow(XDroidPopoverView.this);
					}
				});
	...
	public void dissmissPopover(boolean animated){
		...
		if (popoverViewListener != null)
			popoverViewListener.popoverViewWillDismiss(XDroidPopoverView.this);
		...
		if (!animated){
			...
			if (popoverViewListener != null)
				popoverViewListener.popoverViewDidDismiss(XDroidPopoverView.this);
		}
		else{
			...
			if (!isAnimating){
				...
				animation.setAnimationListener(new AnimationListener() {
					...
					public void onAnimationEnd(Animation animation) {
						...
						popoverView.removeAllViews();
						removeAllViews();
						XDroidPopoverView.this.superview.removeView(XDroidPopoverView.this);
						//End animation
						isAnimating = false;
						//Tell delegate we did dismiss
						if (popoverViewListener != null)
