 ...
 * 代码：
            ...
            label.remove();
 */
public class XDroidLabelView extends TextView {
    ...
    public XDroidLabelView(Context context) {
        this(context, null);
    }

    public XDroidLabelView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public XDroidLabelView(Context context, AttributeSet attrs, int defStyle) {
