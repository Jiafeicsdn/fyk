 ...
 * @author Robin
 */
public class XDroidBadgeView extends TextView {
	...
	public XDroidBadgeView(Context context) {
		this(context, (AttributeSet) null, android.R.attr.textViewStyle);
	}
	
	public XDroidBadgeView(Context context, AttributeSet attrs) {
     ...
     */
	public XDroidBadgeView(Context context, View target) {
     ...
     */
	public XDroidBadgeView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}
	
	public XDroidBadgeView(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}
	
	public XDroidBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
