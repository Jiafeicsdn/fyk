...
import com.xdroid.config.XDroidConfig;
...
public class SystemUtils {
	...
	public static boolean checkOnlyWifi(Context context) {
		if (PreferenceHelper.readBoolean(context, XDroidConfig.SETTING_FILE,
				XDroidConfig.ONLY_WIFI)) {
	...
	public static String getAppVersion(Context context) {
		...
		try {
			...
			throw new XDroidException(SystemUtils.class.getName()
	...
	public static String getSign(Context context, String pkgName) {
		try {
			...
			throw new XDroidException(SystemUtils.class.getName() + "the "
