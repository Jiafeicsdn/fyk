 ...
 *
 */
public class PullToRefreshViewFooter extends LinearLayout {
	...
	public final static int STATE_NORMAL = 5;
	 ...
	 */
	public PullToRefreshViewFooter(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	...
	private void initView(Context context) {
		...
		footerView.setMinimumHeight(ViewUtils.scale(mContext,100));
		footerView.setBackgroundColor(Color.rgb(31, 62, 77));
		...
		ViewUtils.setPadding(footerView, 0, 25, 0, 25);
		...
		layoutParamsWW.rightMargin = ViewUtils.scale(mContext, 10);
