 ...
 * @version v1.0
 */
public class XDroidHorizontalScrollView extends HorizontalScrollView {
	 ...
	 */
	public XDroidHorizontalScrollView(Context context) {
		super(context);
	}
	 ...
	 */
	public XDroidHorizontalScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
