 ...
 * 滑动开关
 * @author Robin
 *  time 2015-03-21 13:10:06
 *  
 *  使用方法：
 *  代码：
    	slide = (XDroidSlideSwitch) findViewById(R.id.swit);
 ...
 *	布局：
    <com.xdroid.widget.XDroidSlideSwitch
        android:id="@+id/swit"
        android:layout_width="190dip"
        android:layout_height="50dip"
        android:layout_marginTop="10dip"
        slideswitch:isOpen="true"
        slideswitch:shape="circle"  //circle为圆形，rect为方形
        slideswitch:themeColor="#ff0a5a00" >
    </com.xdroid.widget.XDroidSlideSwitch>
 */
public class XDroidSlideSwitch extends View {
	...
	public XDroidSlideSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	public XDroidSlideSwitch(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public XDroidSlideSwitch(Context context) {
		this(context, null);
	}
