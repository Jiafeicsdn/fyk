...
/**
 * Manages the lifecycle of {@link SlideToast}s.
 */
final class Manager extends Handler {
  ...
  private final Queue<SlideToast> croutonQueue;

  private Manager() {
    croutonQueue = new LinkedBlockingQueue<SlideToast>();
  }
  ...
  /**
   * Inserts a {@link SlideToast} to be displayed.
   *
   * @param crouton
   *     The {@link SlideToast} to be displayed.
   */
  void add(SlideToast crouton) {
    croutonQueue.add(crouton);
    displayCrouton();
  }

  /**
   * Displays the next {@link SlideToast} within the queue.
   */
  private void displayCrouton() {
    ...
    final SlideToast currentCrouton = croutonQueue.peek();
  ...
  private long calculateCroutonDuration(SlideToast crouton) {
  ...
  /**
   * Sends a {@link SlideToast} within a {@link Message}.
   *
   * @param crouton
   *     The {@link SlideToast} that should be sent.
   * @param messageId
   *     The {@link Message} id.
   */
  private void sendMessage(SlideToast crouton, final int messageId) {
  ...
  /**
   * Sends a {@link SlideToast} within a delayed {@link Message}.
   *
   * @param crouton
   *     The {@link SlideToast} that should be sent.
   * @param messageId
   ...
   */
  private void sendMessageDelayed(SlideToast crouton, final int messageId, final long delay) {
  ...
  public void handleMessage(Message message) {
    final SlideToast crouton = (SlideToast) message.obj;
    if (null == crouton) {
      return;
    }
    switch (message.what) {
  ...
  /**
   * Adds a {@link SlideToast} to the {@link ViewParent} of it's {@link Activity}.
   *
   * @param crouton
   *     The {@link SlideToast} that should be added.
   */
  private void addCroutonToView(final SlideToast crouton) {
  ...
  /**
   * Removes the {@link SlideToast}'s view after it's display
   * durationInMilliseconds.
   *
   * @param crouton
   *     The {@link SlideToast} added to a {@link ViewGroup} and should be
   *     removed.
   */
  protected void removeCrouton(SlideToast crouton) {
    ...
    if (null != croutonParentView) {
      ...
      SlideToast removed = croutonQueue.poll();
  ...
  /**
   * Removes a {@link SlideToast} immediately, even when it's currently being
   * displayed.
   *
   * @param crouton
   *     The {@link SlideToast} that should be removed.
   */
  void removeCroutonImmediately(SlideToast crouton) {
    ...
    final Iterator<SlideToast> croutonIterator = croutonQueue.iterator();
    while (croutonIterator.hasNext()) {
      final SlideToast c = croutonIterator.next();
  ...
  /**
   * Removes all {@link SlideToast}s from the queue.
   */
  void clearCroutonQueue() {
    ...
    // content view
    for (SlideToast crouton : croutonQueue) {
      removeCroutonFromViewParent(crouton);
    }
    croutonQueue.clear();
  }
  ...
  /**
   * Removes all {@link SlideToast}s for the provided activity. This will remove
   * crouton from {@link Activity}s content view immediately.
   */
  void clearCroutonsForActivity(Activity activity) {
    Iterator<SlideToast> croutonIterator = croutonQueue.iterator();
    while (croutonIterator.hasNext()) {
      SlideToast crouton = croutonIterator.next();
  ...
  private void removeCroutonFromViewParent(SlideToast crouton) {
    if (crouton.isShowing()) {
  ...
  private void removeAllMessagesForCrouton(SlideToast crouton) {
