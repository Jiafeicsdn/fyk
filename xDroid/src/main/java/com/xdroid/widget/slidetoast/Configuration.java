...
/**
 * Allows configuring a {@link SlideToast}s behaviour aside from the actual view,
 ...
 * when the {@link SlideToast} is being displayed.
 *
 * @author chris
 * @since 1.8
 */
public class Configuration {
  ...
  /**
   * Display a {@link SlideToast} for an infinite amount of time or
   * until {@link SlideToast#cancel()} has been called.
   */
  public static final int DURATION_INFINITE = -1;
  /** The default short display duration of a {@link SlideToast}. */
  public static final int DURATION_SHORT = 3000;
  /** The default long display duration of a {@link SlideToast}. */
  public static final int DURATION_LONG = 5000;

  /** The default {@link Configuration} of a {@link SlideToast}. */
  ...
  /** The durationInMilliseconds the {@link SlideToast} will be displayed in milliseconds. */
  ...
  public static class Builder {
    ...
    /**
     * Set the durationInMilliseconds option of the {@link SlideToast}.
     *
     * @param duration
     *   The durationInMilliseconds the crouton will be displayed
     *   {@link SlideToast} in milliseconds.
     *
     ...
     *   when the {@link SlideToast} is going to be displayed.
     *
     * @return the {@link Builder}.
     */
     ...
     *   The resource identifier for the animation that's being shown
     *   when the {@link SlideToast} is going to be removed.
     *
     * @return the {@link Builder}.
     */
