...
package com.xdroid.widget.slidetoast;
 ...
 * <p/>
 * <b>Important: </b>
 * Call {@link SlideToast#clearCroutonsForActivity(Activity)} within
 * {@link Activity#onDestroy()} to avoid {@link Context} leaks.
 */
public final class SlideToast {
  ...
  /**
   * Creates the {@link SlideToast}.
   *
   * @param activity
   *     The {@link Activity} that the {@link SlideToast} should be attached
   *     to.
   * @param text
   *     The text you want to display.
   * @param style
   *     The style that this {@link SlideToast} should be created with.
   */
  private SlideToast(Activity activity, CharSequence text, Style style) {
   ...
   *     The style that this {@link SlideToast} should be created with.
   * @param viewGroup
   *     The {@link ViewGroup} that this {@link SlideToast} should be added to.
   */
  private SlideToast(Activity activity, CharSequence text, Style style, ViewGroup viewGroup) {
    if ((activity == null) || (text == null) || (style == null)) {
      throw new IllegalArgumentException(NULL_PARAMETERS_ARE_NOT_ACCEPTED);
    }
   ...
   */
  private SlideToast(Activity activity, View customView) {
   ...
   *     The {@link ViewGroup} that this {@link SlideToast} should be added to.
   */
  private SlideToast(Activity activity, View customView, ViewGroup viewGroup) {
   ...
   *     The {@link ViewGroup} that this {@link SlideToast} should be added to.
   * @param configuration
   *     The {@link Configuration} for this {@link SlideToast}.
   */
  private SlideToast(final Activity activity, final View customView, final ViewGroup viewGroup,
  ...
  /**
   * Creates a {@link SlideToast} with provided text and style for a given
   * activity.
   *
   * @param activity
   *     The {@link Activity} that the {@link SlideToast} should be attached
   ...
   *     The style that this {@link SlideToast} should be created with.
   *
   * @return The created {@link SlideToast}.
   */
  public static SlideToast makeText(Activity activity, CharSequence text, Style style) {
    return new SlideToast(activity, text, style);
  }
   ...
   * @return The created {@link SlideToast}.
   */
  public static SlideToast makeText(Activity activity, CharSequence text, Style style, ViewGroup viewGroup) {
    return new SlideToast(activity, text, style, viewGroup);
  }
   ...
   *     The resource id of the {@link ViewGroup} that this {@link SlideToast} should be added to.
   *
   * @return The created {@link SlideToast}.
   */
  public static SlideToast makeText(Activity activity, CharSequence text, Style style, int viewGroupResId) {
    return new SlideToast(activity, text, style, (ViewGroup) activity.findViewById(viewGroupResId));
  }


  /**
   * Creates a {@link SlideToast} with provided text-resource and style for a given
   * activity.
   *
   * @param activity
   *     The {@link Activity} that the {@link SlideToast} should be attached
   ...
   * @return The created {@link SlideToast}.
   */
  public static SlideToast makeText(Activity activity, int textResourceId, Style style) {
   ...
   * @return The created {@link SlideToast}.
   */
  public static SlideToast makeText(Activity activity, int textResourceId, Style style, ViewGroup viewGroup) {
   ...
   * @return The created {@link SlideToast}.
   */
  public static SlideToast makeText(Activity activity, int textResourceId, Style style, int viewGroupResId) {
    return makeText(activity, activity.getString(textResourceId), style,
   ...
   * @return The created {@link SlideToast}.
   */
  public static SlideToast make(Activity activity, View customView) {
    return new SlideToast(activity, customView);
  }
   ...
   * @return The created {@link SlideToast}.
   */
  public static SlideToast make(Activity activity, View customView, ViewGroup viewGroup) {
    return new SlideToast(activity, customView, viewGroup);
  }
   ...
   * @return The created {@link SlideToast}.
   */
  public static SlideToast make(Activity activity, View customView, int viewGroupResId) {
    return new SlideToast(activity, customView, (ViewGroup) activity.findViewById(viewGroupResId));
  }
  ...
  public static SlideToast make(Activity activity, View customView, int viewGroupResId,
                             final Configuration configuration) {
    return new SlideToast(activity, customView, (ViewGroup) activity.findViewById(viewGroupResId), configuration);
  }

  /**
   * Creates a {@link SlideToast} with provided text and style for a given activity
   * and displays it directly.
   *
   * @param activity
   *     The {@link android.app.Activity} that the {@link SlideToast} should
   *     be attached to.
   * @param text
   *     The text you want to display.
   * @param style
  ...
  /**
   * Allows hiding of a previously displayed {@link SlideToast}.
   *
   * @param crouton
   *     The {@link SlideToast} you want to hide.
   */
  public static void hide(SlideToast crouton) {
    crouton.hide();
  }

  /**
   * Cancels all queued {@link SlideToast}s. If there is a {@link SlideToast}
  ...
  /**
   * Cancels a {@link SlideToast} immediately.
   */
  public void cancel() {
  ...
  /**
   * Displays the {@link SlideToast}. If there's another {@link SlideToast} visible at
   * the time, this {@link SlideToast} will be displayed afterwards.
   */
  public void show() {
  ...
  /**
   * Allows setting of an {@link OnClickListener} directly to a {@link SlideToast} without having to use a custom view.
   *
   * @param onClickListener
   *     The {@link OnClickListener} to set.
   *
   * @return this {@link SlideToast}.
   */
  public SlideToast setOnClickListener(OnClickListener onClickListener) {
    this.onClickListener = onClickListener;
    return this;
  }

  /**
   * Set the {@link Configuration} on this {@link SlideToast}, prior to showing it.
   *
   * @param configuration
   ...
   * @return this {@link SlideToast}.
   */
  public SlideToast setConfiguration(final Configuration configuration) {
    this.configuration = configuration;
    return this;
  }
  ...
  /**
   * @return <code>true</code> if the {@link SlideToast} is being displayed, else
   * <code>false</code>.
   */
  boolean isShowing() {
  ...
  /**
   * Removes the activity reference this {@link SlideToast} is holding
   */
  void detachActivity() {
    activity = null;
  }
  ...
  /**
   * Removes the viewGroup reference this {@link SlideToast} is holding
   */
  ...
  /**
   * Removes the lifecycleCallback reference this {@link SlideToast} is holding
   */
