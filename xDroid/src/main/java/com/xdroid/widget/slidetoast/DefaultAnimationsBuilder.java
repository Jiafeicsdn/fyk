...
/** Builds the default animations for showing and hiding a {@link SlideToast}. */
final class DefaultAnimationsBuilder {
   ...
   *
   * @return The default Animation for a showing {@link SlideToast}.
   */
   ...
   *   The croutonView which gets animated.
   *
   * @return The default Animation for a hiding {@link SlideToast}.
   */
