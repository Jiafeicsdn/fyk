package com.xdroid.widget.stickyheader;
...
import com.xdroid.android.support.annotation.DimenRes;
import com.xdroid.android.support.annotation.IdRes;
import com.xdroid.widget.stickyheader.animator.HeaderStikkyAnimator;
